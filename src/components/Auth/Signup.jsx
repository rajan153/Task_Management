...
import { regiserUser } from "../../service/operations/authApi";
...
function Signup() {
  ...
  const signupHandler = async () => {
    await regiserUser(name, email, password, navigate);
  };
  ...
  return (
    !token && (
      <div className="py-16">
        <form className="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
          <img
